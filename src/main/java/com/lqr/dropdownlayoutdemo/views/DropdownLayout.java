...
import com.lqr.dropdownlayoutdemo.R;
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.DropdownLayout_ddl_top_bg:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_top_height:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_top_split_line_color:
                    topSplitLineColor = typedArray.getColor(attr, Color.LTGRAY);
                    break;
                case R.styleable.DropdownLayout_ddl_top_split_line_width:
                ...
                case R.styleable.DropdownLayout_ddl_top_btn_noraml_drawable:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_top_btn_selected_drawable:
                    topSelectedDrawableResId = typedArray.getResourceId(attr, -1);
                    break;
                case R.styleable.DropdownLayout_ddl_top_bottom_line_color:
                    topBottomLineColor = typedArray.getColor(attr, Color.LTGRAY);
                    break;
                case R.styleable.DropdownLayout_ddl_top_bottom_line_width:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_top_bottom_line_height:
                ...
                //分割线
                case R.styleable.DropdownLayout_ddl_split_line_color:
                    splitLineColor = typedArray.getColor(attr, Color.LTGRAY);
                    break;
                case R.styleable.DropdownLayout_ddl_split_line_width:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_split_line_height:
                ...
                //遮盖层
                case R.styleable.DropdownLayout_ddl_mask_bg:
                    maskBg = typedArray.getColor(attr, Color.GRAY);
                    break;
                //下拉列表最大高度
                case R.styleable.DropdownLayout_ddl_list_max_height:
                    ...
                    break;
                //item
                case R.styleable.DropdownLayout_ddl_item_padding_left:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_item_padding_right:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_item_height:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_item_text_size:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_item_text_normal_color:
                    itemTextNormalColor = typedArray.getColor(attr, Color.BLACK);
                    break;
                case R.styleable.DropdownLayout_ddl_item_text_selected_color:
                    itemTextSelectedColor = typedArray.getColor(attr, Color.BLACK);
                    break;
                case R.styleable.DropdownLayout_ddl_item_normal_bg:
                    itemNormalBg = typedArray.getColor(attr, Color.WHITE);
                    break;
                case R.styleable.DropdownLayout_ddl_item_selected_bg:
                    itemSelectedBg = typedArray.getColor(attr, Color.GRAY);
                    break;
                case R.styleable.DropdownLayout_ddl_item_normal_drawable:
                    itemNormalDrawable = typedArray.getResourceId(attr, -1);
                    break;
                case R.styleable.DropdownLayout_ddl_item_selected__drawable:
                ...
                case R.styleable.DropdownLayout_ddl_item_bottom_line_height:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_item_bottom_line_margin_left:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_item_bottom_line_margin_right:
                    ...
                    break;
                case R.styleable.DropdownLayout_ddl_item_bottom_line_color:
